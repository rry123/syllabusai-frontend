...
export default function LandingPage() {
  return (
    <>
 <div className="relative items-center w-full px-5 py-12 mx-auto md:px-12 lg:px-16 max-w-7xl lg:py-24 my-auto">
  <div className="flex w-full mx-auto text-left">
    <div className="relative inline-flex items-center mx-auto align-middle">
      <div className="text-center">
        ...
        <p className="max-w-xl mx-auto mt-8 text-base leading-relaxed text-gray-500">Empower your study sessions with our AI-driven platform! Effortlessly generate tests, organize notes, and elevate your learning experience to ace every subject.</p>
